...
package net.cbaines.suo.authenticator;

import net.cbaines.suo.Constants;
import net.cbaines.suo.OrganiserActivity;
import net.cbaines.suo.R;
...
class Authenticator extends AbstractAccountAuthenticator {
	...
	public Bundle confirmCredentials(AccountAuthenticatorResponse response,
		...
		final Intent intent = new Intent(mContext, OrganiserActivity.class);
	...
	private boolean onlineConfirmPassword(String username, String password) {
		// Networking stuff from here, check back to Sample
		return true;
	}
